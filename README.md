...
#### Linux
```bash
curl -LO https://github.com/corneliusweig/rakkess/releases/download/v0.4.3/rakkess-amd64-linux.tar.gz \
...
#### OSX
```bash
curl -LO https://github.com/corneliusweig/rakkess/releases/download/v0.4.3/rakkess-amd64-darwin.tar.gz \
...
#### Windows
[https://github.com/corneliusweig/rakkess/releases/download/v0.4.3/rakkess-windows-amd64.zip](https://github.com/corneliusweig/rakkess/releases/download/v0.4.3/rakkess-windows-amd64.zip)
